...
-- Improved Schema:
-- Create separate tables for countries, cities, airlines, passengers, tickets
-- Use foreign keys to reference these tables.
...
CREATE TABLE tickets (
  ...
  airlines_id INT NOT NULL REFERENCES airlines(id),
...
INSERT INTO tickets (passenger_id, seat, departure, arrival, airlines_id, from_city_id, to_city_id)
VALUES
...
(2, '18C', '2018-10-31 01:15:00', '2018-10-31 12:55:00', 5, 9, 10),
(5, '9E', '2019-02-06 06:00:00', '2019-02-06 07:47:00', 1, 11, 12),
